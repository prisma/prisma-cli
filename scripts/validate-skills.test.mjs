...
describe("validateSkillMd", () => {
  ...
  it("fails when bare colons break YAML-style parsing", () => {
    const broken = `---
name: drive-discussion
description: Invoke when resolution: before deploy.
---
...
`;
  ...
  it("fails when description exceeds the skill installer limit", () => {
...
describe("runCheck", () => {
  it("validates every direct skill under a skills directory", () => {
