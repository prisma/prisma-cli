...
import { bucketCreateCommand } from "../src/commands/bucket/create";
import { bucketDeleteCommand } from "../src/commands/bucket/delete";
import { bucketKeyCreateCommand } from "../src/commands/bucket/key-create";
import { bucketKeyDeleteCommand } from "../src/commands/bucket/key-delete";
import { bucketKeyListCommand } from "../src/commands/bucket/key-list";
...
async function pinnedCwd() {
  const cwd = await mkdtemp(path.join(os.tmpdir(), "bucket-test-"));
...
function unpinnedCwd() {
  return mkdtemp(path.join(os.tmpdir(), "bucket-unpinned-"));
}
