  ...
  return checkTarball(
    {
      ...
      // pins the families' 0.5.0-peering releases removes them; while
      ...
      exceptions: [
        {
          ...
          familyPin: "0.4.0",
          shellPin: "0.5.0",
          reason: "engine 0.5.0 must publish before composer-cli can peer it",
          removeWhen:
            "composer-cli releases peering 0.5.0 and the follow-up bump PR pins that release",
        },
        {
          familyPackage: "@prisma/orm-toolchain",
          familyPin: "0.4.0",
          shellPin: "0.5.0",
          reason: "engine 0.5.0 must publish before orm-toolchain can peer it",
          removeWhen:
            "orm-toolchain releases peering 0.5.0 and the follow-up bump PR pins that release",
        },
      ],
      channel: CHANNEL,
